...
namespace Craftify.Infrastructure.Migrations
{
    ...
    [Migration("20240625051219_recreating_Db")]
    partial class recreating_Db
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Craftify.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0bea76d3-3a95-47d5-adc8-39ca67701601"),
                            Blocked = false,
            ...
            modelBuilder.Entity("Craftify.Domain.Entities.Subscription", b =>
                {
                    ...
                    b.HasOne("Craftify.Domain.Entities.User", "Worker")
                        .WithMany()
