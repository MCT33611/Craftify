...
namespace Craftify.Infrastructure.Migrations
{
    ...
    [Migration("20240722055442_chat_repo-side_modify2_add_blocker_id_convTb")]
    partial class chat_reposide_modify2_add_blocker_id_convTb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Craftify.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f750a46c-15e7-43fa-a86a-5767bf5b377e"),
                            Blocked = false,
