...
namespace Craftify.Infrastructure.Migrations
{
    ...
    [Migration("20240722055944_chat_repo-side_modify4_add_blocker_id_convTb")]
    partial class chat_reposide_modify4_add_blocker_id_convTb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Craftify.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bb9a3d81-47f3-49e7-a2b0-e6a8e96ee393"),
                            Blocked = false,
