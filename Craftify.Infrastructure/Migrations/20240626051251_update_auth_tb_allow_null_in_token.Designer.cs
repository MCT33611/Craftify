...
namespace Craftify.Infrastructure.Migrations
{
    ...
    [Migration("20240626051251_update_auth_tb_allow_null_in_token")]
    partial class update_auth_tb_allow_null_in_token
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Craftify.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e0143948-7b2a-4f1a-9c8a-7420b633bb55"),
                            Blocked = false,
